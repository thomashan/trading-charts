...
/**
 * Original implementation from https://github.com/gicentre/geomap
 */
class DoubleParserGeoMap {
     ...
     */
    public DoubleParserGeoMap() {
        // nothing special to do
    }

    public double parse(CharSequence charSequence) throws NumberFormatException {
        readJavaFormatString(charSequence, 0, charSequence.length() - 1);
        return doubleValue();
    }
    ...
    private void readJavaFormatString(CharSequence in, int start, int end) throws NumberFormatException {
