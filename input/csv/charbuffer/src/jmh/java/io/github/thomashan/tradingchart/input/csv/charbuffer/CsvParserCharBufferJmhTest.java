...
public class CsvParserCharBufferJmhTest extends CsvParserJmhTestCase<BidAskOhlc, CsvParserCharBuffer<BidAskOhlc>> {
    @Override
    public CsvParserCharBuffer<BidAskOhlc> getCsvParser() {
